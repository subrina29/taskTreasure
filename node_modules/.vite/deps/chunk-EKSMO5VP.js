...
function $2a41e45df1593e64$export$d39e1813b3bdd0e1(props) {
  ...
  let [position, setPosition] = (0, import_react12.useState)({
    position: {},
...
function $9bf71ea28793e738$var$useFocusContainment(scopeRef, contain) {
  let focusedNode = (0, import_react13.useRef)();
  let raf = (0, import_react13.useRef)();
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
    let scope = scopeRef.current;
    if (!contain) {
      if (raf.current) {
...
function $9bf71ea28793e738$var$useRestoreFocus(scopeRef, restoreFocus, contain) {
  const nodeToRestoreRef = (0, import_react13.useRef)(typeof document !== "undefined" ? (0, $431fbd86ca7dc216$export$b204af158042fbac)(scopeRef.current ? scopeRef.current[0] : void 0).activeElement : null);
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
    let scope = scopeRef.current;
    const ownerDocument = (0, $431fbd86ca7dc216$export$b204af158042fbac)(scope ? scope[0] : void 0);
...
var $e6afbd83fe6ebbd2$var$FocusableContext = (0, import_react16.default).createContext(null);
...
function $e6afbd83fe6ebbd2$var$FocusableProvider(props, ref) {
  ...
  return (0, import_react16.default).createElement($e6afbd83fe6ebbd2$var$FocusableContext.Provider, {
    value: context
  }, children);
}
var $e6afbd83fe6ebbd2$export$13f3202a3e5ddd5 = (0, import_react16.default).forwardRef($e6afbd83fe6ebbd2$var$FocusableProvider);
...
var $96b38030c423d352$export$60d741e20e0aa309 = (0, import_react22.createContext)({});
function $96b38030c423d352$export$574e9b0fb070c3b0() {
  var _useContext;
  return (_useContext = (0, import_react22.useContext)($96b38030c423d352$export$60d741e20e0aa309)) !== null && _useContext !== void 0 ? _useContext : {};
}
...
function $337b884510726a0d$export$c6fdb837b070b4ff(props) {
  ...
  if (!props.disableFocusManagement) contents = (0, import_react23.default).createElement((0, $9bf71ea28793e738$export$20e40289641fbbb6), {
    restoreFocus: true,
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component3, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component3 !== import_react38.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
    const { children } = props;
    const renderedChildren = (0, import_react38.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
    return (0, import_react38.createElement)(Component3, {
      ...elementProps,
...
// node_modules/framer-motion/dist/es/motion/features/layout/MeasureLayout.mjs
var MeasureLayoutWithContext = class extends import_react42.Component {
  /**
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react42.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
var createDomVisualElement = (Component3, options) => {
  return isSVGComponent(Component3) ? new SVGVisualElement(options, { enableHardwareAcceleration: false }) : new HTMLVisualElement(options, {
    allowProjection: Component3 !== import_react43.Fragment,
...
function useForceUpdate() {
  ...
  const deferredForceRender = (0, import_react45.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent }) {
  ...
  const size = (0, import_react46.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
  });
  const { nonce } = (0, import_react46.useContext)(MotionConfigContext);
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const forceRender = (0, import_react49.useContext)(LayoutGroupContext).forceRender || useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react49.useRef)(/* @__PURE__ */ new Map()).current;
  ...
  return (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react49.cloneElement)(child)) });
};
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react51.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react51.useRef)(void 0);
...
var Group = (0, import_react55.forwardRef)(ReorderGroup);
...
function useMotionValue(initial) {
  ...
  const { isStatic } = (0, import_react56.useContext)(MotionConfigContext);
  if (isStatic) {
    const [, setLatest] = (0, import_react56.useState)(initial);
    (0, import_react56.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
...
function ReorderItem({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  const Component3 = useConstant(() => motion(as));
  const context = (0, import_react57.useContext)(ReorderContext);
  const point = {
...
var Item = (0, import_react57.forwardRef)(ReorderItem);
...
//# sourceMappingURL=chunk-EKSMO5VP.js.map
