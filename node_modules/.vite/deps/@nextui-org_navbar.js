...
} from "./chunk-J2OZT7PH.js";
import {
  useAriaButton
} from "./chunk-IFXYDH2Q.js";
import {
...
// node_modules/@nextui-org/navbar/dist/chunk-HNKQQZSS.mjs
...
// node_modules/@nextui-org/navbar/dist/chunk-XBDGBS3U.mjs
...
var useScrollPosition = (props) => {
  ...
  const position = (0, import_react5.useRef)(
    isEnabled ? getScrollPosition(elementRef == null ? void 0 : elementRef.current) : { x: 0, y: 0 }
  );
  const throttleTimeout = (0, import_react5.useRef)(null);
  const handler = (0, import_react5.useCallback)(() => {
...
function useNavbar(originalProps) {
  ...
  const domRef = useDOMRef(ref);
  const prevWidth = (0, import_react6.useRef)(0);
  const navHeight = (0, import_react6.useRef)(0);
  const [isHidden, setIsHidden] = (0, import_react6.useState)(false);
  const handleMenuOpenChange = (0, import_react6.useCallback)(
    (isOpen) => {
...
// node_modules/@nextui-org/navbar/dist/chunk-NTOVBIR5.mjs
...
var Navbar = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime2.jsx)(NavbarProvider, { value: context, children: context.shouldHideOnScroll ? (0, import_jsx_runtime2.jsx)(LazyMotion, { features: domAnimation, children: (0, import_jsx_runtime2.jsx)(
    m.nav,
    {
