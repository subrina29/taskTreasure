...
var MotionConfigContext = (0, import_react56.createContext)({
...
var MotionContext = (0, import_react57.createContext)({});
...
// node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs
var useIsomorphicLayoutEffect = isBrowser2 ? import_react59.useLayoutEffect : import_react59.useEffect;

// node_modules/framer-motion/dist/es/context/LazyContext.mjs
var import_react60 = __toESM(require_react(), 1);
var LazyContext = (0, import_react60.createContext)({ strict: false });
...
function useVisualElement(Component3, visualState, props, createVisualElement2) {
  const { visualElement: parent } = (0, import_react61.useContext)(MotionContext);
  const lazyContext = (0, import_react61.useContext)(LazyContext);
  const presenceContext = (0, import_react61.useContext)(PresenceContext);
  const reducedMotionConfig = (0, import_react61.useContext)(MotionConfigContext).reducedMotion;
  const visualElementRef = (0, import_react61.useRef)();
  ...
  (0, import_react61.useInsertionEffect)(() => {
    visualElement && visualElement.update(props, presenceContext);
  });
  const wantsHandoff = (0, import_react61.useRef)(Boolean(props[optimizedAppearDataAttribute] && !window.HandoffComplete));
...
function useCreateMotionContext(props) {
  const { initial, animate: animate2 } = getCurrentTreeVariants(props, (0, import_react63.useContext)(MotionContext));
  return (0, import_react63.useMemo)(() => ({ initial, animate: animate2 }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate2)]);
}
...
var LayoutGroupContext = (0, import_react64.createContext)({});

// node_modules/framer-motion/dist/es/context/SwitchLayoutGroupContext.mjs
var import_react65 = __toESM(require_react(), 1);
var SwitchLayoutGroupContext = (0, import_react65.createContext)({});
...
function createMotionComponent({ preloadedFeatures: preloadedFeatures2, createVisualElement: createVisualElement2, useRender, useVisualState: useVisualState2, Component: Component3 }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    const configAndProps = {
      ...(0, import_react66.useContext)(MotionConfigContext),
      ...props,
    ...
    if (!isStatic && isBrowser2) {
      ...
      const isStrict = (0, import_react66.useContext)(LazyContext).strict;
  ...
  const ForwardRefComponent = (0, import_react66.forwardRef)(MotionComponent);
  ForwardRefComponent[motionComponentSymbol] = Component3;
  return ForwardRefComponent;
}
function useLayoutId({ layoutId }) {
  const layoutGroupId = (0, import_react66.useContext)(LayoutGroupContext).id;
...
function useSVGProps(props, visualState, _isStatic, Component3) {
  const visualProps = (0, import_react68.useMemo)(() => {
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component3, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component3 !== import_react69.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
    const { children } = props;
    const renderedChildren = (0, import_react69.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
    return (0, import_react69.createElement)(Component3, {
      ...elementProps,
...
function usePresence() {
  const context = (0, import_react72.useContext)(PresenceContext);
  if (context === null)
    return [true, null];
  const { isPresent, onExitComplete, register } = context;
  const id3 = (0, import_react72.useId)();
  (0, import_react72.useEffect)(() => register(id3), []);
...
// node_modules/framer-motion/dist/es/motion/features/layout/MeasureLayout.mjs
var MeasureLayoutWithContext = class extends import_react73.Component {
  /**
...
function MeasureLayout(props) {
  ...
  const layoutGroup = (0, import_react73.useContext)(LayoutGroupContext);
  return (0, import_jsx_runtime2.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react73.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
function useIsMounted() {
  const isMounted = (0, import_react75.useRef)(false);
  useIsomorphicLayoutEffect(() => {
...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react76.useState)(0);
  const forceRender = (0, import_react76.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react76.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent }) {
  ...
  const size = (0, import_react77.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
...
function useUnmountEffect(callback) {
  return (0, import_react79.useEffect)(() => () => callback(), []);
}
...
function onlyElements(children) {
  const filtered = [];
  import_react80.Children.forEach(children, (child) => {
    if ((0, import_react80.isValidElement)(child))
      filtered.push(child);
  });
  return filtered;
}
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const forceRender = (0, import_react80.useContext)(LayoutGroupContext).forceRender || useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react80.useRef)(/* @__PURE__ */ new Map()).current;
  const presentChildren = (0, import_react80.useRef)(childrenToRender);
  const allChildren = (0, import_react80.useRef)(/* @__PURE__ */ new Map()).current;
  ...
  return (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react80.cloneElement)(child)) });
};
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react82.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react82.useRef)(void 0);
...
var DeprecatedLayoutGroupContext = (0, import_react83.createContext)(null);
...
var ReorderContext = (0, import_react85.createContext)(null);
...
function ReorderGroup({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const order = [];
  const isReordering = (0, import_react86.useRef)(false);
...
var Group = (0, import_react86.forwardRef)(ReorderGroup);
...
function useMotionValue(initial) {
  ...
  const { isStatic } = (0, import_react87.useContext)(MotionConfigContext);
  if (isStatic) {
    const [, setLatest] = (0, import_react87.useState)(initial);
    (0, import_react87.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
...
function ReorderItem({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  const Component3 = useConstant(() => motion(as));
  const context = (0, import_react88.useContext)(ReorderContext);
  const point = {
...
var Item = (0, import_react88.forwardRef)(ReorderItem);
...
// node_modules/@nextui-org/theme/dist/chunk-WJIRIXV4.mjs
var toggle = tv({
  slots: {
...
// node_modules/@nextui-org/theme/dist/chunk-FE2UYWMQ.mjs
var select = tv({
  slots: {
...
// node_modules/@nextui-org/theme/dist/chunk-4MIBATA4.mjs
var radio = tv({
  slots: {
...
// node_modules/@nextui-org/theme/dist/chunk-I33PMOA3.mjs
var input = tv({
  slots: {
...
// node_modules/@nextui-org/theme/dist/chunk-OUNBTYJ7.mjs
var checkbox = tv({
  slots: {
...
// node_modules/@nextui-org/theme/dist/chunk-XEPPBQPJ.mjs
var dateInput = tv({
  slots: {
...
// node_modules/@nextui-org/theme/dist/chunk-TSTU52NB.mjs
var datePicker = tv({
  slots: {
...
// node_modules/@nextui-org/theme/dist/chunk-BOVVTMHS.mjs
var autocomplete = tv({
  slots: {
...
//# sourceMappingURL=chunk-GKCPSZDV.js.map
